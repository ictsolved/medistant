package com.sglabs.medistant.adapters;
...
import com.sglabs.medistant.dialogs.IconPicker;
import com.sglabs.medistant.models.Icon;
...
public class IconsAdapter extends RecyclerView.Adapter<IconsAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.reminder_item_icon_grid, viewGroup, false);
